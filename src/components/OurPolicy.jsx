  ...
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-4 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700'>
      ...
      <div>
        ...
        <p className='text-gray-400'>9840563538</p>
      </div>
      ...
      <div>
        ...
        <p className='text-gray-400'>1041, Sobha Meritta, Pudupakkam, Kelambakkam Vandalur Rd, Chennai, 603103</p>
      </div>
      ...
      <div>
        ...
        <p className='text-gray-400'>bhuvanam1503@gmail.com</p>
      </div>
